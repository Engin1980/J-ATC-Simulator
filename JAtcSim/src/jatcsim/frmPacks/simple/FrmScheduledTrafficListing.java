...
import jatcsim.startup.LayoutManager;
...
public class FrmScheduledTrafficListing extends JFrame {
  ...
  private void initComponents(Movement[] movements) {
    ...
    for (int i = 0; i < movements.length; i++) {
      ...
      JPanel pnl = LayoutManager.createFlowPanel(LayoutManager.eVerticalAlign.baseline,  10,
    ...
    JPanel pnlMain = LayoutManager.createBoxPanel(LayoutManager.eHorizontalAlign.center,  0, movementPanels);
