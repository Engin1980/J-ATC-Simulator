...
//    String iniFileName = AppSettings + "\\settings\\appSettingx.xml";
//
...
//
//    ret.radarPackClassName = getString(inf, RADAR_PACK_CLASS, "Pack");
//
...
//
//  public void save() {
//    String iniFileName = JAtcSim.resFolder.toString() + "\\settings\\config.ini";
//
