...
public class CustomWeatherPanel extends JStartupPanel {
  ...
  private final NumericUpDownExtender txtWindHeading = new NumericUpDownExtender(new JSpinner(), 0, 360, 40, 1);
  private final NumericUpDownExtender txtWindSpeed = new NumericUpDownExtender(new JSpinner(), 0, 100, 4, 1);
  private final NumericUpDownExtender txtVisibility = new NumericUpDownExtender(new JSpinner(), 0, 9999, 9999, 100);
  private final NumericUpDownExtender txtHitProbability = new NumericUpDownExtender(new JSpinner(), 0, 100, 0, 1);
  private final ComboBoxExtender<String> cmbClouds = new ComboBoxExtender();
  private final ComboBoxExtender<StartupSettings.Weather.eSnowState> cmbSnowState = new ComboBoxExtender<>();
  private final ComboBoxExtender<PredefinedWeather> cmbPreset = new ComboBoxExtender<>(q -> q.title);
  private final NumericUpDownExtender txtBaseAltitude = new NumericUpDownExtender(new JSpinner(), 0, 20000, 8000, 1000);
  private String icao;
