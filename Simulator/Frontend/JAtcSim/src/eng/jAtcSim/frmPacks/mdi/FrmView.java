...
//    RadarDisplaySettings ds = pack.getAppSettings().appRadarSettings.displaySettings.toRadarDisplaySettings();
//
...
//        this.parent.getDisplaySettings(), ds, behSett, this.parent.getDynamicPlaneFormatter());
//
