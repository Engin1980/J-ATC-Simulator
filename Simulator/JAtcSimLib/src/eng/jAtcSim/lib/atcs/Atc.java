...
public abstract class Atc implements IMessageParticipant {
  ...
  public abstract void unregisterPlaneUnderControl(IAirplaneRead plane);

  public abstract void removePlaneDeletedFromGame(IAirplaneRead plane);

  public abstract void registerNewPlaneUnderControl(IAirplaneRead plane, boolean initialRegistration);
