...
import eng.jAtcSim.newLib.airplanes.pilots.HoldPilot;
...
//    if (plane.getFlightModule().isDeparture() == false)
...
//  }
//
//  public void setRoute(SpeechList<ICommand> route) {
//    this.afterCommands.clearAll();
//    expandThenCommands(route);
//    processSpeeches(route, RoutingModule.CommandSource.procedure);
//  }
//
...
//    processSpeeches(cmds, RoutingModule.CommandSource.procedure);
//  }
//
...
//  }
//
//  public void addNewSpeeches(SpeechList<ICommand> speeches) {
...
//
  public void applyShortcut(Navaid navaid) {
    ...
    this.processSpeeches(skippedCommands, RoutingModule.CommandSource.procedure);
  }
//
...
//      this.queue.clear();
//    } else {
//      processSpeeches(current, RoutingModule.CommandSource.atc);
//    }
//  }
//
...
//    if (targetCoordinate == null && parent.getBehaviorModule().is(HoldPilot.class)) {
//      HoldPilot hb = parent.getBehaviorModule().getAs(HoldPilot.class);
...
//    processSpeeches(cmds, RoutingModule.CommandSource.extension);
//
//    cmds = afterCommands.getAndRemoveSatisfiedCommands(
//        parent, targetCoordinate, AfterCommandList.Type.route);
//    parent.getRecorderModule().logProcessedAfterSpeeches(cmds, "route");
//    processSpeeches(cmds, RoutingModule.CommandSource.route);
//  }
//
//  private void processSpeeches(SpeechList<? extends ICommand> queue, RoutingModule.CommandSource cs) {
//    while (!queue.isEmpty()) {
//      ICommand cmd = queue.get(0);
...
//      SpeechList<? extends ICommand> queue, ICommand cmd,
//      RoutingModule.CommandSource cs, eng.jAtcSim.newLib.area.airplanes.interfaces.IAirplaneWriteSimple plane) {
//
