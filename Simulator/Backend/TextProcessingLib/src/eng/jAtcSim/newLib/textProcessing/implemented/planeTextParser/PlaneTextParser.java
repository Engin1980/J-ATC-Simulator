package eng.jAtcSim.newLib.textProcessing.implemented.planeTextParser;
...
import eng.jAtcSim.newLib.textProcessing.implemented.planeTextParser.typedParsers.*;
...
public class PlaneTextParser implements ITextParser<IForPlaneSpeech> {
  ...
  @Override
  public SpeechList<IForPlaneSpeech> parse(String line) {
