...
import eng.jAtcSim.newLib.speeches.atc.RunwayCheckRequest;
import eng.jAtcSim.newLib.textProcessing.implemented.parsers.defaultParser.common.SpeechParser;

public class RunwayCheckParser extends SpeechParser<RunwayCheckRequest> {
  ...
  @Override
  public RunwayCheckRequest parse(IList<String> blocks) {
...
//    }
    ...
    RunwayCheckRequest.eType type;
    switch (action) {
      case "DO":
        type = RunwayCheckRequest.eType.doCheck;
        break;
      case "TIME":
        type = RunwayCheckRequest.eType.askForTime;
        break;
      default:
        throw new UnsupportedOperationException();
    }

    RunwayCheckRequest ret = new RunwayCheckRequest(rwyName, type);
    return ret;
  }
}
