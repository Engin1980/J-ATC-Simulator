...
//import eng.jAtcSim.lib.eng.jAtcSim.lib.world.approachesOld.Approach;
//
...
//    DescendStage stage = (DescendStage) stages.tryGetLast(q -> q instanceof DescendStage);
//    if (stage == null)
//      return null;
//    else
...
//    DescendStage stage = (DescendStage) stages.tryGetFirst(q -> q instanceof FollowRadialStage);
//    if (stage == null)
//      return null;
//    else
...
//    DescendStage stage = (DescendStage) stages.tryGetFirst(q -> q instanceof DescendStage);
//    if (stage == null)
